...
Petya has an array of n integers a1, a2, ..., an. It is known that n is even. Petya must divide the participants (numbers) into exactly n/2 pairs (ap1, aq1), (ap2, aq2), ... (apn/2, aqn/2). Each index can be included in no more than one pair.
