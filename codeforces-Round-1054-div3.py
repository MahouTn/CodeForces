...
Given an array a of n elements, where each element is equal to -1, 0, or 1. In one operation, you can choose an index i and increase a[i] by 1 (that is, assign a[i] := a[i]+1). Operations can be performed any number of times, choosing any indices.
